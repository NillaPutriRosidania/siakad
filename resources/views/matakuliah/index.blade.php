        ...
        <form method="GET" action="{{ route('matakuliah.index') }}">
            <div class="flex justify-between items-center mx-28">
                <div class="flex gap-2">
                    <a href="{{ route('matakuliah.create') }}" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600">
                        Tambah Mata Kuliah
                    </a>
            ...
            <div class="mx-auto max-w-5xl">
                                ...
                                <tr class="border-b border-gray-200">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex justify-center items-center gap-2">
                                            <form action="{{ route('matakuliah.destroy', $item->Kode_mk) }}" method="POST"
                                            ...
                                            <a href="{{ route('matakuliah.edit', $item->Kode_mk) }}"
                ...
                @else
                    <div class="text-center">
                        <h1 class="text-red-600 font-bold">Data mata kuliah masih kosong</h1>
                    </div>
                @endif
            </div>
        </div>
