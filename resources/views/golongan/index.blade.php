...
@section('content')
    ...
    <div class="mt-4">
        <form method="GET" action="{{ route('golongan.index') }}">
            <div class="flex justify-between items-center mx-28">
                <div class="flex gap-2">
                    <a href="{{ route('golongan.create') }}" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600">
                        Tambah Golongan
                    </a>
                ...
                <div class="flex items-center">
                    <input type="text" name="search" class="w-full p-2 border border-gray-300 rounded-lg mx-4"
                        placeholder="Cari Golongan..." value="{{ request('search') }}">
            ...
            <div class="mx-auto max-w-5xl">
                                ...
                                <tr class="border-b border-gray-200">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex justify-center items-center gap-2">
                                            <form action="{{ route('golongan.destroy', $item->id_Gol) }}" method="POST"
                                            ...
                                            <a href="{{ route('golongan.edit', $item->id_Gol) }}"
                ...
                @else
                    <div class="text-center">
                        <h1 class="text-red-600 font-bold">Data golongan masih kosong</h1>
                    </div>
                @endif
            </div>
        </div>
